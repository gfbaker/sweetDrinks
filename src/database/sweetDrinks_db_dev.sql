...
INSERT INTO `products` (id,nombre,precio,porcentajeAlcohol,volumen,descripcion,stock,descuento,oferta,importado,esPack) VALUES (1,'CYNAR',615,16.5,'750cc','Aperitivo amargo y liviano. Se ha bebido tradicionalmente solo, con soda, gaseosas o zumos. Ha sido redescubierto para utilizar en coctelería por su carácter exótico y el misterio de sus ingredientes en cócteles originales. Se puede preparar con refrescos de naranja o pomelo y se ha popularizado preparado como un Julep, con menta, azúcar y zumo de pomelo. Clásico y popular en Argentina.',200,15,true,false,false),(2,'CAMPARI ',590,28.5,'750cc','Campari es una bebida alcohólica espirituosa obtenida de la infusión de hierbas amargas, plantas aromáticas y frutas en alcohol y agua. Muchos han intentado adivinar el número de ingredientes: dicen que 20 o 60, otros dicen que son 80 ingredientes. Hasta día de hoy, el alcohol y el agua son los únicos ingredientes conocidos de su receta secreta tan especial. Su color rojo vibrante, intenso aroma y su sabor amargo distintivo lo hacen extremadamente versátil, y la perfecta base para algunos de los cócteles más famosos del mundo.',400,20,true,false,false),(3,'GANCIA',390,14,'950cc','Americano Gancia es un aperitivo que se caracteriza por la presencia de sabores herbáceos y cítricos que se combinan con los del vino blanco y el alcohol. El sabor amargo de las hierbas se mezcla con el dulzor del azúcar logrando una bebida amable, agradable al beber, equilibrada y de gran personalidad.',35,10,true,false,false),(4,'JACK DANIELS',5100,40,'750cc','Se suaviza el whisky gota a gota pasándolo por carbón vegetal y luego se deja madurar en barriles que fabrican ellos mismos artesanalmente. Además, no se sigue ningun calendario estricto. El Tennessee Sippin Whisky (whisky de Tennessee para degustación) está listo sólo cuando los catadores dicen que está listo.',3,0,false,true,false),(5,'PACK HEINEKEN x6',1100,4,'473 ml','Nacida en Ámsterdam y criada por el mundo, Heineken es una cerveza premium de gran tradición y calidad. Cebada malteada, agua, lúpulo y la exclusiva levadura A-Yeast® son los ingredientes 100% naturales que le entregan su distintivo sabor y su inigualable calidad.',200,0,false,false,true),(6,'CORONA PORRON',150,4,'330cc','Cerveza clara y brillante, de espuma blanca y consistente. Destacan sus ligeras notas afrutadas, resultado de la fermentación. De cuerpo medio, fresca, balanceada y muy fácil de beber. En boca es moderadamente dulce y recuerda al sabor del cereal.',500,0,false,false,false),(7,'QUILMES STOUT BOTELLA',160,4,'1L','Cerveza negra, de cuerpo y espuma cremosa, su intenso amargor se compensa con notas de chocolate y café provenientes del golpe de fuego que recibe la malta al momento de ser tostada. Es una opción ideal para maridar con postres dulces, platos fuertes, ahumados, tostados o picantes.',500,10,true,false,false),(8,'QUILMES RED LAGGER PACK X6',580,4,'473cc','Red Lager es una cerveza de sabor acaramelado y de color rojo brillante. Está elaborada con maltas tostadas e ingredientes 100% argentinos y es ideal para combinar con todo tipo de carnes, milanesas y picada de quesos',300,0,false,false,true),(9,'ALAMOS RED BLEND',990,14,'750ml','Es un vino exótico: frutado en rojo, bien intenso, y con un trazo expectorante que, una vez en el paladar, aporta delgadez y tensión. Elaborado en Lujan de Cuyo y Valle de Uco. Provincia de Mendoza, Argentina',30,0,false,false,false),(10,'CAFAYATE MALBEC ',365,14,'750ml','COLOR: rojo violáceo intenso con reflejos púrpuras. AROMA: aromático con notas de ciruela, uvas pasas y pimienta roja. BOCA: balanceado, con cuerpo completo y taninos dulces, con un final suave y afrutado. MARIDAJE SUGERIDO: carnes vacunas grilladas, cerdo asado, quesos duros, ragôut.',15,0,false,false,false),(11,'CAFAYATE ROSE',365,13,'750ml','Los rosados salteños tienen una virtud sobre sus pares de otras regiones: son intensos y aromáticos. En ese sentido, este vino de Bodega Etchart cumple el canon a la perfección. Rojo liviano a la vista, su aromática intensa recuerda a cerezas y guindas. Al paladar ingresa goloso, de acidez moderada a baja y con una textura carnosa que le gustará al bebedor de tintos. Muy frío irá bien.',10,0,false,false,false),(12,'FERNET BRANCA',390,39,'450','Bebida alcohólica amarga elaborada a partir de varios tipos de hierbas (mirra, ruibarbo, manzanilla, cardamomo y azafrán, entre otras), que son maceradas en alcohol de uva, filtradas y añejadas en toneles de roble durante un período que puede ser de 6 a 12 meses.',400,15,true,false,false),(13,'SIDRA LA VICTORIA',220,4,'720ml','Sidra La Victoria está elaborada a partir de una cuidadosa selección de su materia prima, la manzana. Basada en una receta tradicional, conserva su esencia de generación en generación, brindando un sabor natural, frutal y burbujeante, agradable para todos e ideal para cualquier ocasión.',70,30,true,false,false),(14,'SIDRA 1888 ROSE',790,5,'750ml','Está elaborada con manzanas seleccionadas del Alto Valle de Río Negro, y toma lo mejor de la flor del hibisco (también llamada como rosa china), lo que le aporta su tinte rosáceo y sensación de frescura. Se trata de una bebida sin TACC (trigo, avena, cebada y centeno), por lo cual es apta para celíacos, muy ligera y amigable al paladar, logrando su equilibrio con el aroma de las rosas.',50,0,false,false,false),(15,'CHANDON ESPUMANTE EXTRA BRUT',885,12,'750ml','Chandon Extra Brut es el gran clásico de Chandon. Las mejores uvas de Chardonnay y Pinot Noir nos permiten crear un espumoso fresco, frutado, elegante, cremoso y equilibrado. Se destaca por su fineza y precisión.',20,0,false,false,false),(16,'VODKA SMIRNOFF',710,38,'700cc','Smirnoff es un vodka de origen ruso, de 37,5% alc./vol., obtenido por triple destilación del alcohol de grano, y filtrado por carbón, cuya fabricación se inició en el año 1864 por Pyotr Alexandrovich Smirnov.',65,0,false,false,false),(17,'ABSOLUT VODKA',2000,40,'750ml','ABSOLUT VODKA está elaborado exclusivamente con ingredientes naturales, y a diferencia de otros vodkas, no contiene azúcares añadidos. Absolut es, de hecho, tan puro como puede ser el vodka. Aún así, la pureza tiene un sabor: rico, con cuerpo y complejo, pero suave y maduro con el carácter distintivo del grano de trigo, seguido de un toque a frutas secas.',30,0,false,false,false),(18,'WHISKY GLENFIDDICH 12 AÑOS',8900,40,'750ml','Glenfiddich 12 es un whisky suave y ligero, fácil de beber. Posee notas intensas de caramelo y vainilla al principio, que luego van matizándose en distintas notas frutales, como las mencionadas pera y manzana. También podremos detectar, ya mucho más sutiles, notas de madera y malta.',5,0,false,true,false),(19,'WHISKY CHIVAS REGAL',4900,40,'750ml','Una mezcla rica y generosa, madurada en barricas de jerez español escogidas a mano por el Maestro Mezclador y su equipo. Estas barricas son especiales y difíciles de encontrar, y forman una pequeña parte de nuestras existencias. Notas de cata: peras dulces y maduras en almíbar, vainilla con caramelo, dulces de canela y un trasfondo de almendras.',15,0,false,true,false),(20,'CUSENIER LICOR DE CAFE',373,24,'700ml','Calidad y buen sabor que se deben a la correcta aplicación de las técnicas de elaboración, que involucran la combinación de la tecnología industrial con la receta artesanal. Los ingredientes utilizados en estos licores son todos de primera calidad, alcoholes nacionales seleccionados, azúcar refinado, leche, frutas seleccionadas y cacao.',50,15,true,false,false),(21,'TIA MARIA CREAMY',1100,17,'690ml','Tia Maria Cream combina el sabor de Tia Maria más la sensualidad de la crema fresca y un toque de finas esencias. Tia Maria Cream es un licor con atributos de sensualidad, misterio y sofisticación. Modo de consumo: solo, con hielo o en tragos.',50,0,false,false,false),(22,'LICOR BAILEYS',2500,17,'750ml','Con un aroma a chocolate y una sensación suave y sedosa en la boca, Baileys tiene sabores ricos de crema de leche, cacao y vainilla. Son estos sabores indulgentes, aromas y texturas aterciopeladas lo que hace de Baileys el licor perfecto para ponerte creativo. Desde el estilo de café que puedes servir con Baileys hasta los cremosos cócteles que puedes ofrecer, ¡este licor es perfecto para creaciones post cena. También es el licor ideal para compartir con la cocina de tu establecimiento, ya que se puede utilizar para hacer deliciosos postres y dulces.',60,0,false,true,false),(23,'LICOR GRAND MARNIER',5200,40,'700cc','Se caracteriza por su brillante color topacio con algunos matices dorados y ámbar. Tiene cierto aroma a naranjas, caramelo y flores. Su sabor es algo amargo con toques de castaña, un definido sabor a coñac y algo de naranjas. El Grand Marnier puede usarse para elaborar cócteles como el Sidecar, Dirty Harry, Grand Mimosa, B-52, Grand Marnier Smash y Grand Smash, entre otros.',5,0,false,true,false);
UNLOCK TABLES;
